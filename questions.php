...
<body>
	...
	<div id="section">
		<div class="status_types">
			<ul class="nav navbar-nav ">
				<li><a href="questions.php">newest</a></li>
				<li><a href="unanswered.php">unanswered</a></li>
				<li><a href="top votted.php">top votted</a></li>
			</ul>
		</div>
		<?php
		$sql="SELECT * FROM status ORDER BY status_id DESC limit 20";
		$res=mysql_query($sql);
			...
			<div>
				<div class="status">
					...
					<div class="status-back">
						...
						<div class="username">
							<h5><a href="profile.php"><?php echo nl2br($username) ?></a></h5>
						</div>
					</div>
